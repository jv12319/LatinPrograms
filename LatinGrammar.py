...
def quiz_func(variable_dict, Num_of_correct, Num_of_incorrect):
    func_words_missed = {}
...
def retry_quiz_func(variable_dict, Num_of_correct, Num_of_incorrect):
    func_words_missed = {}
    for words in variable_dict:
        user_answer = input("Translate " + words +" ")
        status_of_user_answer =check_adj_trans(user_answer,variable_dict,words)
...
if quiz.lower() == "y":
    words_missed = quiz_func(randomized_lat_dic,Num_of_correct,Num_of_incorrect)
    ...
    if retry_errors_answer.lower() == "y":
        retry_quiz_func(words_missed, Num_of_correct, Num_of_incorrect)
    else:
        print("Bye!")
else:
    print("Bye!")
